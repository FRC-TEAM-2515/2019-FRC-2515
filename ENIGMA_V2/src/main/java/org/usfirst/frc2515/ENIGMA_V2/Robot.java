...
public class Robot extends TimedRobot {
    ...
    public static elevatorDriveTrain elevatorDriveTrain;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public static boolean autoSteerEnabled;
    public static boolean autoSteerEngaged;
    ...
    public void robotInit() {
        ...
        elevatorDriveTrain = new elevatorDriveTrain();
    ...
    public void updateSmartDashboard() {
        SmartDashboard.putBoolean("Steer Enabled", autoSteerEnabled);
