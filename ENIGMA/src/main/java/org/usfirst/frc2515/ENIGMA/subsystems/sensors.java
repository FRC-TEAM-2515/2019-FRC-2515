...
public class sensors extends Subsystem {
    ...
    public boolean shouldAutoPilotEngage() {
        if (Robot.isAutoPilotEnabled && isLineDetected() && lineDetectionTimer.get() >= secondsBeforeAutoEngaged){
            return true;
        }
        return false;
    }
