...
public class sensors extends Subsystem {
    ...
    private AHRS ahrs;
    private DigitalInput liftLevel0;
    private DigitalInput liftLevel1;
    private DigitalInput liftLevel2;
    private DigitalInput cargoIntake;
    private DigitalInput liftLimitTop;
    private DigitalInput liftLimitBottom;
    ...
    private String line;
    private Double turn;
    public String lastLiftPosition = ""; //Possible values Top, Middle, Bottom
    public String lastLiftDirection = ""; //Possible values Up, Down
    ...
    public sensors() {
        ...
        liftLevel0 = new DigitalInput(3);
        addChild("liftLevel0",liftLevel0);
        
        
        liftLevel1 = new DigitalInput(4);
        addChild("liftLevel1",liftLevel1);
        
        
        liftLevel2 = new DigitalInput(5);
        addChild("liftLevel2",liftLevel2);
        
        
        cargoIntake = new DigitalInput(6);
        addChild("cargoIntake",cargoIntake);
        
        
        liftLimitTop = new DigitalInput(7);
        addChild("liftLimitTop",liftLimitTop);
        
        
        liftLimitBottom = new DigitalInput(8);
        addChild("liftLimitBottom",liftLimitBottom);
    ...
    public boolean isLiftAtBottom(){
        if(liftLimitBottom.get()){
            lastLiftPosition = "Bottom";
            return true;
        }
        return false;
    }

    public boolean isLiftAtMiddle() {
        if (liftLevel1.get()) {
            lastLiftPosition = "Middle";
            return true;
        }
        return false;
    }
